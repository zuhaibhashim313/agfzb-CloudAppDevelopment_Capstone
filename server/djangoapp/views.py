...
def get_dealerships(request):
    if request.method == "GET":
        context = {}
        url = "https://us-south.functions.appdomain.cloud/api/v1/web/17c71621-9fbd-4875-906b-2c38306fde85/dealership-package/get-dealerships"
...
def get_dealer_details(request, dealer_id):
    context = {}
    if request.method == "GET":
        url = 'https://us-south.functions.appdomain.cloud/api/v1/web/17c71621-9fbd-4875-906b-2c38306fde85/dealership-package/get-review'
...
def add_review(request, dealer_id):
    ...
    if request.user.is_authenticated:
        ...
        if request.method == "GET":
            url = f"https://us-south.functions.appdomain.cloud/api/v1/web/17c71621-9fbd-4875-906b-2c38306fde85/dealership-package/get-dealerships?dealerId={dealer_id}"
        ...
        if request.method == "POST":
            ...
            url = "https://us-south.functions.appdomain.cloud/api/v1/web/17c71621-9fbd-4875-906b-2c38306fde85/dealership-package/get-review"  # API Cloud Function route
